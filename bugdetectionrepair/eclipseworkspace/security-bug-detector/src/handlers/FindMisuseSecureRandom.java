...
public class FindMisuseSecureRandom {
   boolean clear = true;
   ...
   public void execute(EPartService epartService) {
      FindMisuseSecureRandomDetecter detector = new FindMisuseSecureRandomDetecter();
      ExecuteAnalysis ea = new ExecuteAnalysis(detector, 5);
