...
public class DBVoteDown extends DBInfo {
   public static void proc(String responseIdText) {
      ...
      try {
         ...
         System.out.println("[DEBUG] responseId: " + responseIdText + "\tvoteDn: " + voteDn);
         ...
         // process the results
         pstmt.executeUpdate();
         System.out.println("[DEBUG] Vote Down is successfully increased for [responseId: " + responseIdText + "].");
