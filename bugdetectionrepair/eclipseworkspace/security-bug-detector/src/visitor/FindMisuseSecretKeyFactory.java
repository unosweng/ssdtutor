 ...
 * </pre>
 */
public class FindMisuseSecretKeyFactory extends DetectionASTVisitor {
   TraceMisuse traceMisuse;

   public FindMisuseSecretKeyFactory() {
      ParserSAX parser = ParserSAX.getInstance(7);
      this.indicatorClass = parser.getIndicatorClass();
      this.indicatorPattern = "Pattern7";
      ...
      PrintHelper.printDebugMsgH("SecretKeyFactory rules" + this.rules + " searchType[" + this.searchTypeRules + "]");
      traceMisuse = new TraceMisuse(this);
   }

   public FindMisuseSecretKeyFactory(String javaFilePath, CryptoMisuseDetectionTree view) {
