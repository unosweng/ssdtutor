...
public abstract class DetectionASTVisitor extends ASTVisitor {
   ...
   public String indicatorPattern;
   public String message;
   public String pkgName, projectName;
   public String className, methodClassName;
...
//   protected CryptoMisuseDetection cryptoViewer;
   ...
   protected ZestViewer zestViewer;
...
//   }
   ...
   public void setZestViewer(ZestViewer view) {
      this.zestViewer = view;
   }
...
//   }
   ...
   public int getLineNumber(int offset, String javaFilePath) {
      int lineNumber = 0;
      try {
         String source = UTFile.readEntireFile(javaFilePath);
         Document doc = new Document(source);
   ...
   public void setProjectName(String fileName) {
      this.projectName = fileName;
   }
   
//   protected void finalize() {
//      System.out.println("running finalization for detection");
//      setReturnUse.clear();
//      setVarDefUse.clear();
//      setVarFieldUse.clear();
//      tree.clearTreeViewer();
//      indicatorClass = null;
//      indicatorPattern = null;
//      indicatorMethod = null;
//      iPackages = null;
//      this.message = null;
//      pkgDecl.delete();
//      typeDecl.delete();
...
//      javaFilePath = null;
//      group = null;
//      cryptoTreeViewer.clearTableViewer();
//      cryptoTreeViewer.clearTreeViewer();
//      zestViewer.clear();
//      tree.clearTreeViewer();
//      checkParams.clear();
//      argumentString = null;
