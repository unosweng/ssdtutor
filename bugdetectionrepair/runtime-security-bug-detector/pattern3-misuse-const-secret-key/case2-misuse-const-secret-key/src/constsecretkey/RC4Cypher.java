/**
 * Class extracted from MUBench project 005_corona
 */
...
public class RC4Cypher implements Cypher {
	 ...
	 */
	public RC4Cypher(final CertifiedKey key) throws Exception {
	 ...
	 */
	private void setEncryptKey(final byte[] key) throws Exception {
		...
		try {
			...
			throw new Exception("Fail to create and initialize [{0}] cipher", e);
		}
	}
	 ...
	 */
	private void setDecryptKey(final byte[] key) throws Exception {
	...
	public byte[] decrypt(final byte[] data) throws Exception {
		...
		try {
			...
			throw new Exception("Fail to decrypt data with [{0}] cipher", e);
		}
	}
	...
	public byte[] encrypt(final byte[] data) throws Exception {
		...
		try {
			...
			throw new Exception("Fail to encrypt data with [{0}] cipher", e);
		}
	}
}
