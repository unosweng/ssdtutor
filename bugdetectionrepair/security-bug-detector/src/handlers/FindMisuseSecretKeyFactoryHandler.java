...
public class FindMisuseSecretKeyFactoryHandler {
   boolean clear = true;
   ...
   public void execute(EPartService epartService) {
      FindMisuseSecretKeyFactory detector = new FindMisuseSecretKeyFactory();
      ExecuteAnalysis ea = new ExecuteAnalysis(detector, 7);
