...
public class JCA4ReplaceVisitor extends DetectionASTVisitor {
	private CompilationUnit astRoot;
	private String reference, referenceType;
	...
	public JCA4ReplaceVisitor(CompilationUnit astRoot, ASTRewrite rewrite, MethodElement me, String javaFilePath) {
		...
		ParserSAX ruleParser1 = ParserSAX.getRepairReference(reference);
		reference = ruleParser1.getReferenceClass();
